      ...
      {authView === 'sign_in' ? (
        <>
          <form onSubmit={(e) => handleSignIn(e)}>
            <label htmlFor="sign-in__email">Correo Electronico</label>
            <input
              id="sign-in__email"
              label="Email address"
              autoComplete="email"
            ...
            />
            <label htmlFor="sign-in__password">Contraseña</label>
            <input
          ...
          <hr />
          <a onClick={() => setAuthView('sign_up')}>Crear una cuenta</a>
        </>
      ) : authView === 'sign_up' ? (
        <>
          <h4>Registro</h4>
          <form onSubmit={(e) => handleSignUp(e)}>
            <label htmlFor="sign-up__email">Correo Electronico</label>
            <input
              id="sign-up__email"
              label="Email address"
              autoComplete="email"
          ...
          <hr />
          <a onClick={() => setAuthView('sign_in')}>Registrarse</a>
        </>
